...
TON_BILGI = "bilgi"
TON_TEKNIK = "teknik"
TON_ETIKETLERI = {TON_EGLENCE: "🎭 Eğlence Ağırlıklı (%25 bilgi)", TON_DENGELI: "⚖️ Dengeli (%50 bilgi)", TON_BILGI: "🧠 Bilgi Ağırlıklı (%75 bilgi)", TON_TEKNIK: "📊 Teknik Odaklı (%90 bilgi)"}
