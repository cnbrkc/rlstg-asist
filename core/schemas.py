...
FACT_LOCK_SCHEMA = {
    "type": "OBJECT",
    "properties": {"facts": {"type": "ARRAY", "items": {"type": "OBJECT", "properties": {"fact": {"type": "STRING"}, "status": {"type": "STRING", "description": "OBSERVED / VERIFIED / INFERENCE / UNKNOWN"}, "source": {"type": "STRING"}, "source_type": {"type": "STRING"}, "confidence": {"type": "STRING"}}, "required": ["fact", "status"]}}, "turkiye_satis_durumu": {"type": "STRING", "description": "VAR / YOK / BILINMIYOR"}, "turkiye_fiyati": {"type": "STRING"}, "global_fiyat_bilgisi": {"type": "STRING"}, "arastirma_notu": {"type": "STRING"}},
    "required": ["facts", "turkiye_satis_durumu"],
}

EDITORIAL_SCHEMA = {
    "type": "OBJECT",
    "properties": {"story_options": {"type": "ARRAY", "items": {"type": "OBJECT", "properties": {"isim": {"type": "STRING"}, "visual_relevance": {"type": "STRING"}, "fact_strength": {"type": "STRING"}, "curiosity": {"type": "STRING"}, "novelty": {"type": "STRING"}, "emotional_trigger": {"type": "STRING"}, "turkish_audience_relevance": {"type": "STRING"}, "shareability": {"type": "STRING"}, "repetition_risk": {"type": "STRING"}}, "required": ["isim"]}}, "core_story": {"type": "STRING"}, "why_it_matters": {"type": "STRING"}, "primary_facts": {"type": "ARRAY", "items": {"type": "STRING"}}, "visual_moments": {"type": "ARRAY", "items": {"type": "STRING"}}, "audience_trigger": {"type": "STRING"}, "tone": {"type": "STRING"}, "things_to_avoid": {"type": "ARRAY", "items": {"type": "STRING"}}, "potential_hook_territories": {"type": "ARRAY", "items": {"type": "STRING"}}, "discussion_territory": {"type": "STRING", "description": "Threads için tartışma potansiyeli olan açı."}},
...
REELS_CREATIVE_SCHEMA = {
    ...
    "properties": {
        ...
        "duo_stratejisi": {"type": "OBJECT", "properties": {"uygunluk": {"type": "STRING", "description": "DUO / SOLO_FEMALE / SOLO_MALE"}, "hook_speaker": {"type": "STRING", "description": "female / male / none"}, "female_agirligi": {"type": "NUMBER", "description": "0-1 arasında yaklaşık yaratıcı ağırlık; matematiksel zorunluluk değildir."}, "male_agirligi": {"type": "NUMBER", "description": "0-1 arasında yaklaşık yaratıcı ağırlık; matematiksel zorunluluk değildir."}, "interaction_level": {"type": "NUMBER", "description": "0-1. Karakterlerin birbirine doğrudan tepki verme düzeyi."}, "humor_level": {"type": "NUMBER", "description": "0-1. İçeriğe uygun mizah düzeyi."}, "tension_level": {"type": "NUMBER", "description": "0-1. Hafif fikir ayrılığı/çekişme düzeyi; marka hedefleme değildir."}, "selected_detail": {"type": "STRING", "description": "Diyaloğun merkezine alınabilecek en güçlü vurucu detay."}, "ending_speaker": {"type": "STRING", "description": "female / male / none"}, "rationale": {"type": "STRING"}}, "required": ["uygunluk", "hook_speaker", "female_agirligi", "male_agirligi", "interaction_level", "humor_level", "tension_level", "selected_detail", "ending_speaker", "rationale"]},
