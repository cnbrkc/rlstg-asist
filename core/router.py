...
class SmartRouter:
    ...
    def _tts_performans_promptu_olustur(self, metin: str, ses_adi: str, teslimat: str = "") -> str:
        ...
        return (
            ...
            "Small audible reactions belong where the line calls for them: a dry chuckle, a breath of surprise, "
            "a skeptical pause, a warm smile in the voice. "
    ...
    def _tts_coklu_promptu_olustur(self, metin: str, speaker_names, teslimat: str = "") -> str:
        ...
        return (
            ...
            "# DIRECTOR'S NOTES\n"
            "Style: Underplay it, but never flatten it. Speak in contemporary conversational Turkish with grounded confidence and dry warmth. "
            "React to the meaning of the previous line before advancing your own point — with a real reaction, not a polite nod. "
            "Do not sound polished in the same way. "
            ...
            "Sometimes one speaker holds the floor for two or three lines in a row before the other cuts in; that is normal here, not a mistake. "
            ...
            "Pacing: Fast, alert cold open in the first two turns; then natural variation. Short reactions stay short and dry — a scoff, a chuckle, a quick 'hah'; "
            ...
            "Dynamics: Emotional changes are content-led and uneven, but they must be AUDIBLE in the voice. Let real reactions show: "
            "a dry chuckle, a skeptical scoff, a beat of surprise, a smirk in the tone, a clipped pushback, a warm laugh. "
            "No mechanical 'excited/serious/amazed' rotation across turns, no cartoon gasps, no radio smile, no theatrical projection or overacting. "
            "Distinct personalities, shared acoustic space.\n"
