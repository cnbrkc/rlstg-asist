    ...
    for update in updates:
        ...
        try:
            if video:
                ...
                send_message(chat_id, "🤖 Reels Asistanı hazır.\\n\\nŞimdilik bana küçük bir video gönder. Video alma testini yapacağız.")
            elif message.get("text"):
                send_message(chat_id, "🎥 Şimdilik bana bir video gönder. Diğer komutları birazdan ekleyeceğiz.")
